...
def cal_acc(data_list, pred_folder, classes):
    ...
    #iou_class_weighted = freq_weight*iou_class
    #mIoU_weighted = np.mean(iou_class_weighted)
    #print('Eval result: weighted mIOU:',mIoU_weighted)
    #for i in range(classes):
    #    print('Class_{} result: iou_weighted {:.4f}'.format(i, iou_class_weighted[i]))
