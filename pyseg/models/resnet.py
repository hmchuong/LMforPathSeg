...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, zero_init_residual=False,
        ...
        self.fpn = fpn
        self.downsample_before_x1 = downsample_before_x1
...
def resnet152(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(model_urls['resnet152'],map_location="cpu"),strict=False)
    return model
